...
export const timelineAndPurchasesSelector = createSelector(purchasesByIdSelector, itemsSelector, partiesByPurchaseIdSelector, (purchasesById: Dictionary<Purchase>, items: TimelineItem[], partiesByPurchaseId: Dictionary<Party>): Array<TimelineItemPurchase> => {
